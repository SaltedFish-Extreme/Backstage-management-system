        ...
        <section class="content"> <!--订单信息-->
            ...
            <div class="panel panel-default">
                ...
                <div class="row data-type">
                    ...
                    <div class="col-md-4 data text">${orders.people.nickname }</div>

                    <div class="col-md-2 title">联系人</div>
                    <div class="col-md-4 data text">${orders.people.name}</div>

                    <div class="col-md-2 title">手机号</div>
                    <div class="col-md-4 data text">${orders.people.phoneNum}</div>

                    <div class="col-md-2 title">邮箱</div>
                    <div class="col-md-4 data text">${orders.people.email}</div>
